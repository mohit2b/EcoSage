...
model_name = "/mnt/Data/mohit_prj22/MiniGPT-4/weights/vicuna_llama_7b"
...
# with open('./generated_response/zero_shot/vicuna/test_generated_list_30_tok.p', 'wb') as f:
#     pickle.dump(test_generated_list, f)

# with open('./generated_response/zero_shot/vicuna/test_generated_list_with_input_30_tok.p', 'wb') as f:
#     pickle.dump(test_generated_list_with_input, f)
...
with open('./generated_response/five_shot/vicuna/test_generated_list_30_tok.p', 'wb') as f:
    pickle.dump(test_generated_list, f)

with open('./generated_response/five_shot/vicuna/test_generated_list_with_input_30_tok.p', 'wb') as f:
    pickle.dump(test_generated_list_with_input, f)
