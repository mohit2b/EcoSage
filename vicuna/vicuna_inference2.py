...
save_path = "./save_model/vicuna/vicuna_epoch_1"
...
with open('./generated_response/fine_tune/vicuna/test_generated_list_30_tok.p', 'wb') as f:
    pickle.dump(test_generated_list, f)

with open('./generated_response/fine_tune/vicuna/test_generated_list_with_input_30_tok.p', 'wb') as f:
    pickle.dump(test_generated_list_with_input, f)
