...
# checkpoint_path = hf_hub_download("bert-base-uncased", "pytorch_model.bin")
...
# with open('./generated_response/zero_shot/vicuna/test_generated_list.p', 'wb') as f:
#     pickle.dump(test_generated_list, f)

# with open('./generated_response/zero_shot/vicuna/test_generated_list_with_input.p', 'wb') as f:
#     pickle.dump(test_generated_list_with_input, f)

# with open('./generated_response/zero_shot/llama2/test_generated_list_30_tok.p', 'wb') as f:
#     pickle.dump(test_generated_list, f)

# with open('./generated_response/zero_shot/llama2/test_generated_list_with_input_30_tok.p', 'wb') as f:
#     pickle.dump(test_generated_list_with_input, f)

# with open('./generated_response/five_shot/vicuna/test_generated_list.p', 'wb') as f:
#     pickle.dump(test_generated_list, f)

# with open('./generated_response/five_shot/vicuna/test_generated_list_with_input.p', 'wb') as f:
#     pickle.dump(test_generated_list_with_input, f)

with open('./generated_response/five_shot/llama2/test_generated_list_30_tok.p', 'wb') as f:
    pickle.dump(test_generated_list, f)

with open('./generated_response/five_shot/llama2/test_generated_list_with_input_30_tok.p', 'wb') as f:
    pickle.dump(test_generated_list_with_input, f)
