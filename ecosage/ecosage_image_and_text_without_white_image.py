...
for epoch in range(5):
    ...
    if(valid_loss< min_val_loss):
        ...
        model.llama_model.save_pretrained(f'./save_model/minigpt_decoder_weights/epoch_{epoch}')
        torch.save(model.llama_proj.state_dict(), f'./save_model/llama_proj_epoch_{epoch}')
        print('model saved\n')