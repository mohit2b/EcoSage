...
class MiniGPT4(Blip2Base):
    ...
    def __init__(
        ...
        if self.low_resource:
            ...
            save_path = "./save_model/minigpt_decoder_weights/white_image/epoch_1"
...
model.llama_proj.load_state_dict(torch.load('./save_model/white_image/llama_proj_epoch_1'))
...
with open('./save_model/test_generated_list_new_all_white_image_30_tok.p', 'wb') as f:
    pickle.dump(test_generated_list, f)
