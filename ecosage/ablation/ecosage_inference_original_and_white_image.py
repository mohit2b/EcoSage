...
class MiniGPT4(Blip2Base):
    ...
    def __init__(
        ...
        if self.low_resource:
            ...
            save_path = "./save_model/minigpt_decoder_weights/original_and_white/epoch_1"
...
model.llama_proj.load_state_dict(torch.load('./save_model/original_and_white/llama_proj_epoch_1'))
