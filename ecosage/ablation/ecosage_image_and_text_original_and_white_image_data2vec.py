...
class MiniGPT4(Blip2Base):
    ...
    def encode_img(self, image):
        ...
        # print("self vis enc shape : ", self_vis_enc.shape)
        # print("image embeds shape : ", image_embeds.shape)
        # print("query tokens shape : ", query_tokens.shape)
        # print('query output shape : ', query_output.last_hidden_state.shape)
        # print('inputs llama shape : ', inputs_llama.shape)
        # print(1/0)
...
for epoch in range(5):
    ...
    if(valid_loss< min_val_loss):
        ...
        model.llama_model.save_pretrained(f'./save_model/minigpt_decoder_weights/original_and_white/epoch_data2vec_{epoch}')
        torch.save(model.llama_proj.state_dict(), f'./save_model/original_and_white/llama_proj_data2vec_epoch_{epoch}')
        print('model saved\n')