    ...
    def generate_function(self, text_input, image):
        ...
        seg_tokens = [
            self.llama_tokenizer(
                ...
                max_length=2048).to(self.device).input_ids
            # only add bos to the first seg
...
test_generated_list = return_generate(test_input, image_loc_list, present_list)
...
# with open('/mnt/Data/mohit_prj22/plant_assistant_experiment/final_data/test_generated_list_image_zero_shot.p', 'wb') as f:
