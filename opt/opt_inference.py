...
save_path = "./save_model/opt/opt_epoch_1"
...
# with open('./generated_response/fine_tune/opt/train_generated_list.p', 'wb') as f:
#     pickle.dump(train_generated_list, f)

# with open('./generated_response/fine_tune/opt/train_generated_list_with_input.p', 'wb') as f:
#     pickle.dump(train_generated_list_with_input, f)


# with open('./generated_response/fine_tune/opt/valid_generated_list.p', 'wb') as f:
#     pickle.dump(valid_generated_list, f)

# with open('./generated_response/fine_tune/opt/valid_generated_list_with_input.p', 'wb') as f:
#     pickle.dump(valid_generated_list_with_input, f)


# with open('./generated_response/fine_tune/opt/test_generated_list.p', 'wb') as f:
#     pickle.dump(test_generated_list, f)

# with open('./generated_response/fine_tune/opt/test_generated_list_with_input.p', 'wb') as f:
#     pickle.dump(test_generated_list_with_input, f)

with open('./generated_response/fine_tune/opt/test_generated_list_30_tok.p', 'wb') as f:
    pickle.dump(test_generated_list, f)

with open('./generated_response/fine_tune/opt/test_generated_list_with_input_30_tok.p', 'wb') as f:
    pickle.dump(test_generated_list_with_input, f)
