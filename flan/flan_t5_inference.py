...
save_path = "./save_model/flan_t5/flan_t5_epoch_3"
...
# train_generated_list = return_generate(train_input)
# valid_generated_list = return_generate(valid_input)
...
# with open('./generated_response/fine_tune/flan_t5/train_generated_list.p', 'wb') as f:
#     pickle.dump(train_generated_list, f)

# with open('./generated_response/fine_tune/flan_t5/valid_generated_list.p', 'wb') as f:
#     pickle.dump(valid_generated_list, f)

# with open('./generated_response/fine_tune/flan_t5/test_generated_list.p', 'wb') as f:
#     pickle.dump(test_generated_list, f)

with open('./generated_response/fine_tune/flan_t5/test_generated_list_30_tok.p', 'wb') as f:
    pickle.dump(test_generated_list, f)
