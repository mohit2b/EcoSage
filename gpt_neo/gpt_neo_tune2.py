...
train_dataloader = DataLoader(PlantDataset(train_input_ids, train_attention_mask), batch_size=2, shuffle=True)
valid_dataloader = DataLoader(PlantDataset(valid_input_ids, valid_attention_mask), batch_size=2, shuffle=True)
...
def train_valid(model, train_loader, valid_loader):
    ...
    for epoch in range(5):
        ...
        if(valid_loss < min_val_loss):
            ...
            model.save_pretrained(f"./save_model/gpt_neo/gpt_neo_epoch_{epoch}")
            print('model saved\n')
