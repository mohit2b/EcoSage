...
tokenizer = AutoTokenizer.from_pretrained(model_name, model_max_length = 2048, truncation_side = 'left')
...
save_path = "./save_model/gpt_neo/gpt_neo_epoch_1"
...
# with open('./generated_response/fine_tune/gpt_neo/train_generated_list.p', 'wb') as f:
#     pickle.dump(train_generated_list, f)

# with open('./generated_response/fine_tune/gpt_neo/train_generated_list_with_input.p', 'wb') as f:
#     pickle.dump(train_generated_list_with_input, f)


# with open('./generated_response/fine_tune/gpt_neo/valid_generated_list.p', 'wb') as f:
#     pickle.dump(valid_generated_list, f)

# with open('./generated_response/fine_tune/gpt_neo/valid_generated_list_with_input.p', 'wb') as f:
#     pickle.dump(valid_generated_list_with_input, f)


# with open('./generated_response/fine_tune/gpt_neo/test_generated_list.p', 'wb') as f:
#     pickle.dump(test_generated_list, f)

# with open('./generated_response/fine_tune/gpt_neo/test_generated_list_with_input.p', 'wb') as f:
#     pickle.dump(test_generated_list_with_input, f)


with open('./generated_response/fine_tune/gpt_neo/test_generated_list_30_tok.p', 'wb') as f:
    pickle.dump(test_generated_list, f)

with open('./generated_response/fine_tune/gpt_neo/test_generated_list_with_input_30_tok.p', 'wb') as f:
    pickle.dump(test_generated_list_with_input, f)
